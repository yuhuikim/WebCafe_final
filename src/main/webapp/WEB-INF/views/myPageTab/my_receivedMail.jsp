...
<div align="center">
	<ul class="pagination">
		<c:if test="${pbm.startPage > pbm.pagePerBlock}">
			<li><a href="my_receivedMail.html?pageNum=1">
				<span class="glyphicon glyphicon-backward"></span>
			</a></li>
			<li><a href="my_receivedMail.html?pageNum=${pbm.startPage-1}">
				<span class="glyphicon glyphicon-triangle-left"></span>
			</a></li>
		</c:if>
		<c:forEach var="i" begin="${pbm.startPage}" end="${pbm.endPage}">
			<c:if test="${i==pbm.currentPage}">
				<li class="active"><a href="my_receivedMail.html?pageNum=${i}">${i}</a></li>
			</c:if>
			<c:if test="${i!=pbm.currentPage}">
				<li><a href="my_receivedMail.html?pageNum=${i}">${i}</a></li>
			</c:if>
		</c:forEach>
		<c:if test="${pbm.endPage < pbm.totalPage }">
			<li><a href="my_receivedMail.html?pageNum=${pbm.endPage+1}">
				<span class="glyphicon glyphicon-triangle-right"></span>
			</a></li>
			<li><a href="my_receivedMail.html?pageNum=${pbm.totalPage}">
